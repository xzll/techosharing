...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="${basePath}/css/journal.css"/>
...
<!-- 导航栏 -->
  <div class="ma">
  <header>
  <input type="button" class="back" name="Submit" onclick="javascript:history.back(-1);" value="返回">
    <!-- 导航栏右边 -->
     <div class="he_right">
...
<div class="adMain" id="adMain" style="display:none">
  ...
  <script src="${basePath}/js/journal.js"></script>
