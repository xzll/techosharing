...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${basePath}/js/admin/content/techoList.js"></script>
	</head>
	<body style="background: #e1e9eb;">
		<form action="${basePath}/admin/techo/search" id="mainForm" method="post">
			...
			<div class="right">
				...
				<div class="rightCont">
					<p class="g_title fix">手帐列表（√）要平行的</p>
